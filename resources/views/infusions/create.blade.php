        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">Create Infusions</div>
                            <div role="tabpanel" class="tab-pane active" id="maincho">
                                <div class="container-fluid">
                                    {!! Form::open(array('method' => 'post', 'route' => array('infusions.store'))) !!}
                                    <div class="col-md-12" id="create-form">
                                        ...
                                        <div class="form-group col-md-8">
                                            ...
                                            {{ Form::text('InfusionLocation', Input::old('InfusionLocation'), array('class' => 'form-control')) }}
                                        </div>
                                        ...
                                        <div class="form-group col-md-8">
                                            ...
                                            {{ Form::text('DayofPeriodStart', Input::old('DayofPeriodStart'), array('class' => 'form-control')) }}
                                        </div>

                                        <div class="form-group col-md-8">
                                            {{ Form::label('DayofPeriodStop', 'DayofPeriodStop') }}
                                            {{ Form::text('DayofPeriodStop', Input::old('DayofPeriodStop'), array('class' => 'form-control')) }}
                                        </div>

                                        <div class="form-group col-md-8">
                                            {{ Form::label('TimeofDayStart', 'TimeofDayStart') }}
                                            {{ Form::text('TimeofDayStart', Input::old('TimeofDayStart'), array('class' => 'form-control')) }}
                                        </div>

                                        <div class="form-group col-md-8">
                                            {{ Form::label('TimeofDayStop', 'TimeofDayStop') }}
                                            {{ Form::text('TimeofDayStop', Input::old('TimeofDayStop'), array('class' => 'form-control')) }}
                                        </div>

                                        {{ Form::submit('Create the Infusion', array('class' => 'btn btn-primary')) }}
