        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">Create Dietary Nutrient</div>
                            <div role="tabpanel" class="tab-pane active" id="maincho">
                                <div class="container-fluid">
                                    {!! Form::open(array('method' => 'post', 'route' => array('nutrient.store'))) !!}
                                    <div class="col-md-12" id="create-form">
                                        ...
                                        {{ Form::submit('Create the Dietary Nutrient', array('class' => 'btn btn-primary')) }}
